...
class Agent(BaseAgent):
    ...
    def train_model(self, X, y):
        ...
        m5 = LogisticRegression(random_state=0, solver='lbfgs', multi_class='ovr')

        model = VotingClassifier(estimators=[('cat', m1), ('ada', m2), ('xgb', m3), ('rf', m4), ('lr', m5)], voting='soft')
        model = model.fit(X, y)
        return model
